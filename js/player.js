...
// Returns "" if alive, "spike" if a spike got them, "fall" if they fell off.  
Player.isDead = function () {  
  var size = CONFIG.PLAYER_SIZE;  
  if (Collide.hitsSpike(Player.x, Player.y, size, size)) { return "spike"; }  
  if (Player.y > CONFIG.CANVAS_H + 200) { return "fall"; }   // fell off the world  
  return "";  
};  
